...
$sql = "
    SELECT p.*, 
           ...
           GROUP_CONCAT(DISTINCT pc.size SEPARATOR ', ') AS sizes
    FROM products p
                            ...
                            <div class="col-12 col-md-3 mb-3">
                                <a href="product_detail.php?id=<?php echo $product['product_id']; ?>">
                                    <div class="w-[250px] h-[360px]">
                                        <img class="justify-content-center" src="<?= $product['image'] ?>" class="" alt="<?php echo htmlspecialchars($product['name']); ?>">
                                    </div>
                                    <div class="py-3">
                                        ...
                                        <div class="card-text text-sm mt-2" style="display: flex; align-items: center;">
                                            ...
                                            foreach ($colors as $color) { ?>
                                                <span style="display: inline-block; width: 10px; height: 10px; background-color: <?php echo htmlspecialchars(trim($color)); ?>; border: 1px solid #000; margin-right: 5px;"></span>
                                            <?php } ?>
                                        </div>
                                    </div>
                                </a>
