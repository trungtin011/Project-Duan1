...
<div class="container flex justify-content-center">
    ...
    <div class="sidebar col-3">
        ...
        <div class="list-group mt-3">
            <a href="./account.php?page=orders" class="list-group-item list-group-item-action flex justify-between items-center py-3">
                <div class="flex gap-3">
                    <svg role="img" aria-hidden="true" fill="currentColor" focusable="false" viewBox="0 0 24 24"
            ...
            <a href="./account.php?page=settings" class="list-group-item list-group-item-action flex justify-between items-center py-3">
                <div class="flex gap-3">
                    <svg role="img" aria-hidden="true" fill="currentColor" focusable="false" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg" height="24" width="24" class="UserMenu-module--icon__2dN8a">
                        <path fill-rule="evenodd"
            ...
            <a href="./account.php?page=point" class="list-group-item list-group-item-action flex justify-between items-center py-3">
                <div class="flex gap-3">
                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" focusable="false">
                        <path
            ...
            <a href="./account.php?page=member" class="list-group-item list-group-item-action flex justify-between items-center py-3">
                <div class="flex gap-3">
                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" focusable="false">
                        <path
            ...
            <a href="./account.php?page=contact" class="list-group-item list-group-item-action flex justify-between items-center py-3">
                <div class="flex gap-3">
                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" focusable="false">
                        <path
            ...
            <a href="./account.php?page=product_reviews" class="list-group-item list-group-item-action flex justify-between items-center py-3">
                <div class="flex gap-3">
                    <svg role="img" aria-hidden="true" fill="currentColor" focusable="false" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg" height="24" width="24" class="UserMenu-module--icon__2dN8a">
                        <path
    ...
    <main class="col-6 sidebar">
        <?php
        // Danh sách các trang có sẵn
        $pages = [
            'home' => 'account_content.php',
            'orders' => 'account_orders.php',
            'profile' => 'account_profile.php',
            'settings' => 'account_setting.php',
            'point' => 'account_point.php',
            'contact' => 'account_contact.php',
            'product_reviews' => 'account_product_previews.php',
            'edit_profile' => 'account_edit_profile.php',
            'order_detail' => 'account_order_detail.php',
            'edit_address' => 'account_edit_address.php',
            'add_address' => 'account_add_address.php',
            'delete_address' => '../View/function-CRUD/Delete_Address.php',
        ];
